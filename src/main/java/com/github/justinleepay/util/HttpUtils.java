...
import com.github.justinleepay.kit.StrKit;
...
public final class HttpUtils {
    ...
    private static class HttpKitDelegate implements HttpDelegate {
        ...
        @Override
        public String get(String url) {
            return com.github.justinleepay.kit.HttpKit.get(url);
        }

        @Override
        public String get(String url, Map<String, String> queryParas) {
            return com.github.justinleepay.kit.HttpKit.get(url, queryParas);
        }

        @Override
        public String post(String url, String data) {
            return com.github.justinleepay.kit.HttpKit.post(url, data);
        }
        @Override
		public String post(String url, Map<String, String> queryParas) {
			return com.github.justinleepay.kit.HttpKit.post(url, queryParas, "null");
		}
